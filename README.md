...
## 🧠 VoxelMorph 3D Neural Architecture & Pipeline

### 1. End-to-End Registration Pipeline
![VoxelMorph Registration Pipeline](results/figures/voxelmorph_pipeline_overview.png)
...
### 3. Technical Progression: VoxelMorph v1 (Baseline) vs. VoxelMorph v2 (Proposed SOTA)
